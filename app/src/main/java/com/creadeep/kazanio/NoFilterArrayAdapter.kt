...
/**
 * Without this class ticket type cannot be changed after generating one and going back!
 ...
 */
class NoFilterArrayAdapter<String>(context: Context, layout: Int, var values: Array<String>) :
